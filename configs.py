...
class Config(object):
	API_ID = int(os.environ.get("API_ID", 28341884))
	API_HASH = os.environ.get("API_HASH", "ca0c9295ce3ec910fd6f49e99970d9a8")
	BOT_TOKEN = os.environ.get("BOT_TOKEN","")
	BOT_USERNAME = os.environ.get("BOT_USERNAME" , "LDC_FILE_STORE_BOT")
	DB_CHANNEL = int(os.environ.get("DB_CHANNEL", -1001772120203))
	BOT_OWNER = int(os.environ.get("BOT_OWNER", "6230062482"))
	DATABASE_URL = os.environ.get("DATABASE_URL","mongodb+srv://ashuroy761:YYBzDc7XWi85sRPE@cluster0.umhohdy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
	UPDATES_CHANNEL = os.environ.get("UPDATES_CHANNEL", "-1002243672451")
	LOG_CHANNEL = os.environ.get("LOG_CHANNEL", "-1001892618400")
